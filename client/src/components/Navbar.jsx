...
const Navbar = () => {
  ...
  return (
    ...
    <div id='navbar' className="flex justify-center items-center mt-5 fixed top-0 z-50 w-full ">
      <nav className="flex justify-between items-center w-full max-w-5xl px-4 py-2 rounded-full  backdrop-blur-sm border  border-white/10 text-white shadow-sm mx-2">
        <div>
          <img
