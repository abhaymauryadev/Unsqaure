...
const Hero = () => {
  return (
    <div className="w-full h-screen relative  flex  justify-center items-center top-[-200px]">
      ...
      <div className="absolute flex  flex-col justify-center items-center z-100  ">
      <div className="flex flex-col justify-center items-center mt-12 px-4 sm:px-8">
        <h1
          className="font-semibold text-white mt-[300px] mb-12 text-center font-poppins
          text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-72 md:leading-[112%]"
        >
          Accelerate Sales Growth with <br className="hidden sm:block" /> Tech
          Expert
        </h1>
        <p className="text-white justify-center mt-[65px] items-left text-base sm:text-lg md:text-xl  max-w-5xl">
        ...
        <div className="mt-20 flex flex-col sm:flex-row gap-4 sm:gap-8 w-full max-w-xl mb-20 ">
        ...
        <div className=" mr-18 animate-bounce">
